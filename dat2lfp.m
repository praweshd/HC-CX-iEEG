...
% USAGE 
% This file dat2lfp loads DAT EEG File and downsamples to LFP file. 
% Streams data, filters it, and writes it into a new file with the same filename and defined extension.  
%
% REQUIREMENTS
%       f_in:          filename with extention. for example: 'data.dat'
%       extention:     extention of the filtered file. for example: 'lfp' 
%       Rs:            sampling rate
%       Rs_new:        new sampling rate 
%       CH_:           total number of channels 

%       Note:   must be in path of .dat file and -states.mat(from StateEditor) file 
%
% Prawesh Dahal (2018); revised for BRAIN 
